package com.jplayer.player.component.simple;
...
public class PlayerController {
    ...
    private String volOffIcon  = getClass().getResource("/images/icon/volume_off.png").toString();
    private String volOnIcon  = getClass().getResource("/images/icon/volume_On.png").toString();
    private String maxIcon  = getClass().getResource("/images/icon/max.png").toString();
